  ...
  static ThemeData _generateBasicTheme(
    ...
    final _textTheme = _defaultTextTheme.copyWith(
      ...
      headline6: _themeData.textTheme.headline6.medium
          ...
          .fontFamilies(_fontFamily)
          .textColor(_isDark ? MyColors.text.combineWhite40 : MyColors.text),
      subtitle1: _themeData.textTheme.subtitle1.fontFamilies(_fontFamily),
      subtitle2: _themeData.textTheme.subtitle2.fontFamilies(_fontFamily),
      bodyText1: _themeData.textTheme.bodyText1.regular
          .size(16.0)
          .fontFamilies(_fontFamily)
          .textColor(_isDark ? MyColors.text.combineWhite40 : MyColors.text),
      bodyText2: _themeData.textTheme.bodyText2.regular
          .size(14.0)
          .fontFamilies(_fontFamily)
          .textColor(_isDark ? MyColors.description.combineWhite40 : MyColors.description),
      button: _themeData.textTheme.button.fontFamilies(_fontFamily).semiBold,
      caption: _themeData.textTheme.caption.fontFamilies(_fontFamily).size(12.0),
      overline: _themeData.textTheme.overline.fontFamilies(_fontFamily).size(10.0),
    );
